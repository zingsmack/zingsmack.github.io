...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const reel = [
    { embedId: 'NbRVYsKg2AQ', caption: 'Video 1: [Your title here]' },
    { embedId: '3o9SVt5B4M0', caption: 'Video 2: [Your title here]' },
    { embedId: 'Mcr2E1LSJUI', caption: 'Video 3: [Your title here]' },
